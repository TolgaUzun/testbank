...
<head>
    ...
    <title>Test Bank | Yönetim Paneli</title>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#" class="btn btn-default btn-flat">Ayarlar</a>
                                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?= base_url("admin/onayliSorular") ?>"><i class="fa fa-circle-o"></i> Onaylı Sorular</a></li>
                        <li><a href="<?= base_url("admin/onaysizSorular") ?>"><i class="fa fa-circle-o"></i> Onaysız Sorular</a></li>
                        <li><a href="<?= base_url("admin/sorular") ?>"><i class="fa fa-circle-o"></i> Sorular</a></li>
                        <li><a href="<?= base_url("admin/soruEkle") ?>"><i class="fa fa-circle-o"></i> Soru Ekle</a></li>
                    </ul>
                </li>
                <li>
